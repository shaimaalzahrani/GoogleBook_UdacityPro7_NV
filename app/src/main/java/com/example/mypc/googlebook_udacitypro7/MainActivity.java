...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView = (android.widget.SearchView) findViewById(R.id.search_view_main_activity);
    ...
    private void updateBookList() {
        bookListArrayAdapter = new BookList(getBaseContext(), bookList);
